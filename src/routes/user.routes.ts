...
userRouter.get("/myteam-players", isAuth, userService.getPlayersByMyTeam); // MANAGER
...
userRouter.put("/:id", isAuth, userService.updateUser); // TODOS LOS LOGADOS A SI MISMOS PERO NO EL ROL / ADMIN A OTROS
